...
from qai_hub_models.models._shared.exaone4.model import DEFAULT_USER_PROMPT
...
# EXAONE4 specific end tokens
END_TOKENS = {"[|endofturn|]", "[|eot_id|]", "</s>"}


def exaone4_1_2b_chat_demo(
    ...
    """
    Demo function for EXAONE4 1.2B chat interface.
    
    This demo shows how to use the EXAONE4 1.2B model for conversational AI,
    including support for reasoning mode with <think> blocks and tool calling.
    """
    llm_chat_demo(
        model_cls=model_cls,
